...
int main(int argc, char **argv) {
    link_t pub_lidar = ufr_sys_publisher("lidar", "@new zmq:topic @host 127.0.0.1 @port 5001 @coder msgpack");
    link_t sub_motors = ufr_sys_subscriber("motor", "@new zmq:topic @host 127.0.0.1 @port 5002 @coder msgpack");
    link_t pub_compass = ufr_sys_publisher("compass", "@new zmq:topic @host 127.0.0.1 @port 5003 @coder msgpack @message ff");
    link_t pub_encoder = ufr_sys_publisher("encoder", "@new zmq:topic @host 127.0.0.1 @port 5004 @coder msgpack");
